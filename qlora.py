...
Original file is located at
    https://colab.research.google.com/drive/1fyevV9CQsGzN2QqqgRyASFO9i3gbPVK-
"""
...
def main():
    ...
    lora_config = LoraConfig(
        r=32,  # Increased rank for potentially better performance
        lora_alpha=32,
    ...
    training_args = TrainingArguments(
        ...
        seed=SEED,
        bf16=True,  # Use bf16 for better performance with quantization
        eval_strategy="epoch",
