...
Original file is located at
    https://colab.research.google.com/drive/1A4I8ql2xe2vdb0ZZWgOEojYfS7AZVe1G
"""
...
TRAIN_PATH = "/scratch/vsetpal/speed/train.json"
VAL_PATH   = "/scratch/vsetpal/speed/standardized_dev_data.json"
OUT_DIR    = "/scratch/vsetpal/flan_results"

# === Flatten Event Mentions ===
...
def load_data(path):
    ...
    with open(path) as f:
        for line in f:
            ...
            src = f'extract events: "{row.get("sentence", "").strip()}"'
...
# === Constants ===
OUT_DIR   = "/scratch/vsetpal/flan_results"
TEST_PATH = "/scratch/vsetpal/speed/standardized_test_data.json"
MAX_SRC   = 512
MAX_TGT   = 256
BATCH_SIZE = 2
